...
public abstract class AbstractUI {
  ...
  protected static final String[] APPLICATION_COPYRIGHT  = new String[] {"University of British Columbia", "Copyright \u00A9 2010-2020 Mike Feeley.", "All rights reserved."};
  ...
  throws ArgException {
    ...
    if (!isRequired || valueIfSwitchMissing!=null) {
      if (valueIfSwitchMissing!=null)
        return Arrays.asList (valueIfSwitchMissing);
      else
  ...
  protected static boolean hasArg (ArrayList <String> args, String arg) {
    for (String a : args)
      if (a .equals (arg))
        return true;
    return false;
  ...
  public static void main (String[] argsArray) {
    ...
    try {
      ...
      if (uiName .equals ("gui") && hasArg (args, "-d"))
        uiName = "cli";
      try {
